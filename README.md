...
In multiple mode, click a start date, hold Shift, and click an end date to select every date in that period. Starting from an already selected date removes that period instead.
